...
export function Footer() {
    return (
        <footer id="contact" className="relative bg-zinc-50 text-black pt-32 pb-12 overflow-hidden px-6 lg:px-8">
            ...
            <div className="relative z-10 max-w-7xl mx-auto text-center">
                ...
                <div className="mt-40 pt-12 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between text-gray-500">
